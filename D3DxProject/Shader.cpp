	...
	* pd3dCommandList, void* pContext)
{
	...
	//				XMFLOAT3 rotateAxis = XMFLOAT3(0.0f, 1.0f, 0.0f);
	//				xmf3RotateAxis = Vector3::CrossProduct(rotateAxis, xmf3SurfaceNormal);
	//				if (Vector3::IsZero(xmf3RotateAxis)) xmf3RotateAxis = XMFLOAT3(0.0f, 1.0f, 0.0f);
	//				XMFLOAT3 angle = XMFLOAT3(0.0f, 1.0f, 0.0f);
	//				float fAngle = acos(Vector3::DotProduct(angle, xmf3SurfaceNormal));
