...
class CPlayer : public CAirplaneObject
{
protected:
...
public:
	...
	void SetPosition(XMFLOAT3& xmf3Position) {
		XMFLOAT3 targetPos = XMFLOAT3(xmf3Position.x - m_xmf3Position.x, xmf3Position.y - m_xmf3Position.y, xmf3Position.z - m_xmf3Position.z);
