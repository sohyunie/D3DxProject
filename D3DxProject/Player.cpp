...
CCamera* CPlayer::OnChangeCamera(DWORD nNewCameraMode, DWORD nCurrentCameraMode)
{
	...
	{
		DirectX::XMFLOAT3 right = XMFLOAT3(m_xmf3Right.x, 0.0f, m_xmf3Right.z);
		m_xmf3Right = Vector3::Normalize(right);

		DirectX::XMFLOAT3 up = XMFLOAT3(0.0f, 1.0f, 0.0f);
		m_xmf3Up = Vector3::Normalize(up);

		DirectX::XMFLOAT3 look = XMFLOAT3(m_xmf3Look.x, 0.0f, m_xmf3Look.z);
		...
		XMFLOAT3 xmfloat3 = XMFLOAT3(0.0f, 0.0f, 1.0f);
		XMVECTOR zRotateBase = XMLoadFloat3(&xmfloat3);
		XMVECTOR lookVector = XMLoadFloat3(&m_xmf3Look);

		m_fYaw = Vector3::Angle(zRotateBase, lookVector);
...
void CPlayer::LookAt(XMFLOAT3& xmf3LookAt, XMFLOAT3& xmf3Up)
{
	...
	XMFLOAT3 rightBase = XMFLOAT3(xmf4x4View._11, xmf4x4View._21, xmf4x4View._31);
	XMFLOAT3 upBase = XMFLOAT3(xmf4x4View._12, xmf4x4View._22, xmf4x4View._32);
	XMFLOAT3 lookBase = XMFLOAT3(xmf4x4View._13, xmf4x4View._23, xmf4x4View._33);
	m_xmf3Right = Vector3::Normalize(rightBase);
	m_xmf3Up = Vector3::Normalize(upBase);
	m_xmf3Look = Vector3::Normalize(lookBase);
}


void CTerrainPlayer::UpdatePos()
{
	m_xmf4x4World._11 = m_xmf3Right.x; m_xmf4x4World._12 = m_xmf3Right.y; m_xmf4x4World._13 = m_xmf3Right.z;
	m_xmf4x4World._21 = m_xmf3Up.x; m_xmf4x4World._22 = m_xmf3Up.y; m_xmf4x4World._23 = m_xmf3Up.z;
	m_xmf4x4World._31 = m_xmf3Look.x; m_xmf4x4World._32 = m_xmf3Look.y; m_xmf4x4World._33 = m_xmf3Look.z;
...
void CTerrainPlayer::Shoot()
{
	...
	if (pBulletObject)
	{
		...
		pBulletObject->SetStartPosition(xmf3Position);
	...
	nMeshes) : CPlayer(nMeshes)
{
	...
	CMesh* pAirplaneMesh = new CMesh(pd3dDevice, pd3dCommandList);
	m_pCamera = ChangeCamera(THIRD_PERSON_CAMERA, 0.0f);
...
CCamera* CTerrainPlayer::ChangeCamera(DWORD nNewCameraMode, float fTimeElapsed)
{
	...
	case FIRST_PERSON_CAMERA:
		...
		XMFLOAT3 setGravity_firstPerson = XMFLOAT3(0.0f, -250.0f, 0.0f);
		SetGravity(setGravity_firstPerson);
	...
	case SPACESHIP_CAMERA:
		...
		XMFLOAT3 setGravity_spaceCamera = XMFLOAT3(0.0f, 0.0f, 0.0f);
		SetGravity(setGravity_spaceCamera);
		SetMaxVelocityXZ(300.0f);
		SetMaxVelocityY(400.0f);
	...
	case THIRD_PERSON_CAMERA:
		...
		XMFLOAT3 setGravity_thirdPerson = XMFLOAT3(0.0f, -250.0f, 0.0f);
		SetGravity(setGravity_thirdPerson);
		SetMaxVelocityXZ(300.0f);
		SetMaxVelocityY(400.0f);
...
void CTerrainPlayer::OnCameraUpdateCallback(float fTimeElapsed)
{
	...
	if (xmf3CameraPosition.y <= fHeight)
	{
		...
		if (m_pCamera->GetMode() == THIRD_PERSON_CAMERA)
		{
			...
			p3rdPersonCamera->SetLookAt(getPos);
		}
	}
}