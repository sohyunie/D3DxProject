...
CPlayer::CPlayer(int nMeshes) : CAirplaneObject(nMeshes)
{
	m_pCamera = NULL;
...
CAirplanePlayer::CAirplanePlayer(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature)
{
	...
	CAirplaneObject* pGameObject = CAirplaneObject::LoadGeometryFromFile(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, "Model/Gunship.bin");
...
CCamera* CAirplanePlayer::ChangeCamera(DWORD nNewCameraMode, float fTimeElapsed)
{
	...
	XMFLOAT3 gravityPos = XMFLOAT3(0.0f, 0.0f, 0.0f);
	switch (nNewCameraMode)
	{
	case FIRST_PERSON_CAMERA:
		SetFriction(2.0f);
		SetGravity(gravityPos);
