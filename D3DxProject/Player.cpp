	...
	CPlayer(nMeshes)
{
	...
	XMFLOAT3 setPos = XMFLOAT3(0.0f, 0.0f, -50.0f);
	SetPosition(setPos);
...
CCamera* CAirplanePlayer::ChangeCamera(DWORD nNewCameraMode, float fTimeElapsed)
{
	...
	case FIRST_PERSON_CAMERA:
		...
		SetFriction(200.0f);
		DirectX::XMFLOAT3 gravityFPC = XMFLOAT3(0.0f, 0.0f, 0.0f);
		SetGravity(gravityFPC);
	...
	case THIRD_PERSON_CAMERA:
		...
		SetFriction(250.0f);
		DirectX::XMFLOAT3 gravityTPC = XMFLOAT3(0.0f, 0.0f, 0.0f);
		SetGravity(gravityTPC);
		SetMaxVelocityXZ(125.0f);
		SetMaxVelocityY(400.0f);
